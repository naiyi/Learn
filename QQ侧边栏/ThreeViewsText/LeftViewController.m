...
- (void)addConstraint {
    // 头像图片
    UIImageView *headImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"head"]];
    ...
    [tanName setTitle:@"按钮1" forState:(UIControlStateNormal)];
    ...
    [messageButton setTitle:@"按钮2" forState:(UIControlStateNormal)];
    ...
    [gButton setTitle:@"按钮3" forState:(UIControlStateNormal)];
    ...
    [settingsButton setTitle:@"按钮4" forState:(UIControlStateNormal)];
    ...
    [newPeopleButton setTitle:@"按钮5" forState:(UIControlStateNormal)];
    ...
    [recommendPeopleButton setTitle:@"按钮6" forState:(UIControlStateNormal)];
    ...
    /*
     //    [self.view addConstraint:tanWigth];
     //    [self.view addConstraint:gButtonWigth];
     //    [self.view addConstraint:messageButtonWigth];
     //    [self.view addConstraint:settingsButtonWigth];
     //    [self.view addConstraint:newPeopleButtonWigth];
     //    [self.view addConstraint:recommendPeopleButtonWigth];
     */
