...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    localNoti.alertTitle=@"闹钟";
    localNoti.alertBody=@"起床了";
    localNoti.soundName=@"11.mp3";
...
-(void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification
{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"消息" message:notification.alertBody delegate:nil cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
    [alertView show];
