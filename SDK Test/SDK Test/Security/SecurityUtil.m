...
#define Iv          [[ApplicationRuntime currentRuntime] AESOffset] //偏移量,可自行修改

#define KEY         [[ApplicationRuntime currentRuntime] AESKey] //key，可自行修改
...
+(NSString*)decryptAESData:(NSString *)string
{
    ...
    //使用密码对data进行解密
    NSData *decryData = [decodeBase64Data AES128DecryptWithKey:[[dict objectForKey:@"object"] objectForKey:@"sKey"] gIv:[[dict objectForKey:@"object"] objectForKey:@"ivParameter"]];
