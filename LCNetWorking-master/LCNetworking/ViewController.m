...
//    params[@"type"] = @"consultant";
    ...
    [LCNetworking PostWithURL:@"http://portal.snapwifi.me:8180/snapwifi/app/phone_queryHotsList" Params:@{@"appkey":@"e270c8272cf4c3786da083440Da2577fip"} success:^(NSDictionary *responseObject) {
