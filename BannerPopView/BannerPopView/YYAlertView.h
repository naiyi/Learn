...
@interface YYAlertView : UIViewController
...
-(instancetype)initwithWithText:(NSArray *)text clickCallBack:(ClickCallBack)clickCallBack andCloseCallBack:(CloseCallBack)closeCallBack;
