...
#define K_UrlString @"http://c.3g.163.com/nc/article/list/T1368497029546/0-20.html"

@interface YYSixViewController ()
{
//    NSString *_path;
...
@implementation YYSixViewController
...
- (void)loadNewStatuses
{
    [BSHttpRequest GET:K_UrlString parameters:nil success:^(id responseObject) {
        ...
        if ([obj isKindOfClass:[NSDictionary class]]) {
            NSMutableArray *list =obj[@"T1368497029546"];
...
- (void)loadMoreStatuses
{
    static NSInteger i;
    i+=20;
    NSString *urlstring=[NSString stringWithFormat:@"http://c.3g.163.com/nc/article/list/T1368497029546/%li-20.html",i];
...
//
        NSArray *T1348647909107 = [obj objectForKey:@"T1368497029546"];
