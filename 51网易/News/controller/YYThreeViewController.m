...
#define k_url_string @"http://c.3g.163.com/nc/article/list/T1414389941036/0-20.html"
...
- (void)loadNewStatuses
{
    [BSHttpRequest GET:k_url_string parameters:nil success:^(id responseObject) {
        ...
        if ([obj isKindOfClass:[NSDictionary class]]) {
            NSMutableArray *list =obj[@"T1414389941036"];
...
- (void)loadMoreStatuses
{
    ...
    NSString *urlstring =[NSString stringWithFormat:@"http://c.3g.163.com/nc/article/list/T1414389941036/%li-20.html",i];
